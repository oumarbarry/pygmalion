...
<template>
  <PygPage :title="collection?.title ?? t('loading')" back-to="/admin/produits/collections">
    ...
    <PygEmptyState
      ...
      action-to="/admin/produits/collections"
    />
    ...
    <template v-else>
      ...
      <UCard>
        ...
        <div class="flex flex-col gap-4">
          ...
          <PygList :items="members" :columns="columns" :to="(p) => `/admin/produits/${p.id}`">
