...
async function confirmDelete() {
  ...
  try {
    ...
    await navigateTo('/admin/promotions/campagnes')
  } finally {
...
<template>
  <PygPage :title="campaign?.name ?? t('loading')" back-to="/admin/promotions/campagnes">
    ...
    <PygEmptyState
      ...
      action-to="/admin/promotions/campagnes"
    />
