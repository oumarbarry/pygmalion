...
<template>
  <PygPage :title="customer?.name || customer?.email || t('loading')" back-to="/admin/clients">
    ...
    <template v-else>
      ...
      <UCard>
        ...
        <div class="flex flex-col gap-4">
          ...
          <PygList :items="memberOf" :columns="groupColumns" :to="(g) => `/admin/clients/groupes/${g.id}`">
      ...
      <UCard>
        ...
        <div class="flex flex-col gap-4">
          <PygList :items="orders" :columns="orderColumns" :to="(o) => `/admin/commandes/${o.id}`">
