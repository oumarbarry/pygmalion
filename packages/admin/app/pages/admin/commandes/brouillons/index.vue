...
<template>
  <PygPage :title="t('draftsTitle')" :description="t('draftsSubtitle')" back-to="/admin/commandes">
    <template #actions>
      <UButton to="/admin/commandes/brouillons/nouveau" icon="i-lucide-plus" :label="t('draftNew')" />
    </template>
    ...
    <PygList v-else :items="drafts" :columns="columns" :loading="loading" :to="(d) => `/admin/commandes/brouillons/${d.id}`">
