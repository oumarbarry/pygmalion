...
<template>
  <PygPage :title="t('sectionOrders')" :description="t('ordersSubtitle')">
    <template #actions>
      <UButton to="/admin/orders/drafts" color="neutral" variant="outline" icon="i-lucide-file-pen-line" :label="t('ordersDraftsLink')" />
    </template>
    ...
    <div class="flex flex-col gap-4">
      ...
      <PygList v-else :items="visible" :columns="columns" :loading="loading && !rows.length" :to="(o) => `/admin/orders/${o.id}`">
