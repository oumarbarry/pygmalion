...
const title = computed(() => {
  ...
  const country = countryName(taxRegion.value.countryCode)
...
<template>
  <PygPage :title="title" :description="t('setTaxRateSubtitle')" back-to="/admin/reglages/taxes">
    <template #actions>
    ...
    <UCard v-else>
      <PygEmptyState
        ...
        :action-label="t('back')"
        action-to="/admin/reglages/taxes"
      />
    </UCard>
  </PygPage>
</template>
